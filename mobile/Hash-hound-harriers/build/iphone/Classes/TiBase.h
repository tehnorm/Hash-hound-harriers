...
// in simulator we redefine to format for Hash_hound_harriers Developer console
...
{\
	NSString * exceptionName = [@"org.hash_hound_harriers." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hash_hound_harriers";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIHash_hound_harriersNativeItemNone = -1, 
	UIHash_hound_harriersNativeItemSpinner = -2,
	UIHash_hound_harriersNativeItemProgressBar = -3,
	
	UIHash_hound_harriersNativeItemSlider = -4,
	UIHash_hound_harriersNativeItemSwitch = -5,
	UIHash_hound_harriersNativeItemMultiButton = -6,
	UIHash_hound_harriersNativeItemSegmented = -7,
	
	UIHash_hound_harriersNativeItemTextView = -8,
	UIHash_hound_harriersNativeItemTextField = -9,
	UIHash_hound_harriersNativeItemSearchBar = -10,
	
	UIHash_hound_harriersNativeItemPicker = -11,
	UIHash_hound_harriersNativeItemDatePicker = -12,
	
	UIHash_hound_harriersNativeItemInfoLight = -13,
	UIHash_hound_harriersNativeItemInfoDark = -14,
	
	UIHash_hound_harriersNativeItemDisclosure = -15,
	
	UIHash_hound_harriersNativeItemContactAdd = -16
};
